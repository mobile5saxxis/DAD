...
public class BestProducts_model implements Parcelable {
    ...
    protected BestProducts_model(Parcel in) {
    ...
    public static final Creator<BestProducts_model> CREATOR = new Creator<BestProducts_model>() {
        @Override
        public BestProducts_model createFromParcel(Parcel in) {
            return new BestProducts_model(in);
        }

        @Override
        public BestProducts_model[] newArray(int size) {
            return new BestProducts_model[size];
        }
    };
