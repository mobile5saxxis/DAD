...
public class NewArrivals_Model implements Parcelable {
    ...
    protected NewArrivals_Model(Parcel in) {
    ...
    public static final Creator<NewArrivals_Model> CREATOR = new Creator<NewArrivals_Model>() {
        @Override
        public NewArrivals_Model createFromParcel(Parcel in) {
            return new NewArrivals_Model(in);
        }

        @Override
        public NewArrivals_Model[] newArray(int size) {
            return new NewArrivals_Model[size];
        }
    };
