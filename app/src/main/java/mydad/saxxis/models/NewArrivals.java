...
public class NewArrivals implements Parcelable {
    ...
    protected NewArrivals(Parcel in) {
    ...
    public static final Creator<NewArrivals> CREATOR = new Creator<NewArrivals>() {
        @Override
        public NewArrivals createFromParcel(Parcel in) {
            return new NewArrivals(in);
        }

        @Override
        public NewArrivals[] newArray(int size) {
            return new NewArrivals[size];
        }
    };
