...
public class BaseURL {
    ...
    public static String BASE_URL = "http://saxxishrsolution.com.md-33.webhostbox.net/DAD/";
    ...
    public static String GET_BEST_PRODUCTS = BASE_URL + "index.php/api/best_product?sid=1";

    public static String GET_NEW_ARRIVALS = BASE_URL + "index.php/api/new_arrival_products";
