...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            iv_spinner = view.findViewById(R.id.tv_spinner);
...
*/
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.iv_subcat_plus) {
                ...
                map.put("tv_title", modelList.get(position).getTitle());
    ...
    public ProductAdapter(List<Product> modelList, Context context) {
    ...
    public void onBindViewHolder(final ProductAdapter.MyViewHolder holder, int position) {
        final Product mList = modelList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Product androidVersion : modelList) {
