...
public class BestProductsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new BestProductsDetailsActivity.SectionsPagerAdapter(getSupportFragmentManager());
