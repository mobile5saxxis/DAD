...
import android.codecanyon.grocery.util.Log;
...
import java.codecanyon.grocery.util.ArrayList;
import java.codecanyon.grocery.util.HashMap;
import java.codecanyon.grocery.util.List;
import java.codecanyon.grocery.util.Map;

import codecanyon.grocery.Adapter.Product_adapter;
import Config.BaseURL;
import codecanyon.grocery.Model.Category_model;
import codecanyon.grocery.Model.PopularBrands_Model;
import codecanyon.grocery.Model.Product_model;
import codecanyon.grocery.AppController;
import codecanyon.grocery.activities.MainActivity;
import codecanyon.grocery.R;
import codecanyon.grocery.util.ConnectivityReceiver;
import codecanyon.grocery.util.CustomVolleyJsonRequest;
...
public class Products_fragment extends Fragment {
    ...
    private List<PopularBrands> brands_modelList = new ArrayList<>();
    private List<Product> brandlist = new ArrayList<>();

    private List<Product> product_modelList = new ArrayList<>();
...
/*Toolbar toolbar = (Toolbar) view.findViewById(R.id.toolbar);
    ...
    private void makeGetProductRequest(final String cat_id, final Boolean isCatogery) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                APIAPIUrls.GET_PRODUCT_URL, params, new Response.Listener<JSONObject>() {
...
/*JSONObject data = response.getJSONObject("data");*//*
                        ...
                        adapter_product = new ProductAdapter(brandlist, getActivity());
